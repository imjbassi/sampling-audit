...
\textbf{Alanine dipeptide} (all-atom, 3 basins). A 100 ns Langevin dynamics
simulation in implicit solvent (OpenMM \cite{eastman2017}, amber14 \cite{maier2015} with GBn2 \cite{nguyen2013}, 2 fs
...
\textbf{A limitation specific to this validation.} All results in this section come
...
\textbf{A second 100 ns seed is the single highest-value remaining experiment.}
...
that the \emph{properly-sampled} 100 ns result is seed-independent---only that the
